...
(function () {
  ...
  function renderInto(container, markdown) {
    ...
    if (!entries.length) {
      container.innerHTML = '<p class="publications-empty">No publications or writing items added yet. Edit publications.md to show your work here.</p>';
      return 0;
    }
